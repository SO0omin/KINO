...
export const useSeatWebSocket = (isOpen, screeningId, initialSeats) => {
    const [currentSeats, setCurrentSeats] = useState(initialSeats);
        ...
        stompClient.connect({}, () => {
            stompClient.subscribe(`/topic/screening/${screeningId}`, (message) => {
                ...
                setCurrentSeats((prevSeats) => {
                    ...
                    return prevSeats.map((s) => Number(s.id) === Number(updatedData.seatId)
